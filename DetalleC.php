...
<p style="color:red;"><?php
        $querySelect="SELECT producto_id FROM $tabla";
...
<div class="col-sm-2">
      ...
      <input type="int" name="ID_producto" placeholder="100xx" class="form-control" required>
...
<table class="table table-hover">
    <tr class="table">
      <th scope="row">Datos del producto</th>
      <td>Id</td>
      <td>Nombre</td>
      <td>Costo venta</td>
      <td>Cantidad</td>
...
<div>
<form action="Update.php" method="POST" class="text-primary" enctype="multipart/form-data">
<legend>Datos del producto</legend>
<div class="text-secondary">
<div class="form-group row">
<div class="col-sm-2">
